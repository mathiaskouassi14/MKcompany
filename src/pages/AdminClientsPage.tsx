        ...
        <div>
          ...
          <div className="mt-6 border-b border-slate-700">
            <nav className="-mb-px flex space-x-8">
              <button className="border-b-2 border-emerald-500 py-2 px-1 text-sm font-medium text-emerald-400">
                Inscriptions LLC
              </button>
              <button className="border-b-2 border-transparent py-2 px-1 text-sm font-medium text-slate-400 hover:text-slate-300">
                Clients existants
              </button>
            </nav>
          </div>
